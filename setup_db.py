...
# Comment out if deleting values
...
# Deleting Values
# Comment out when adding values into table
# c.execute("DELETE FROM app_users WHERE user_id = U03L471LSD6")
# c.execute("DELETE * FROM team_sites ")
